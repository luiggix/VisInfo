...
#
from utils import maxminTicks, inicializaGrafica, graficaFertilidad, graficaFertilidadUnPais
#
...
print(p_max, y_maximo)
print('yticks = ', yticks)
print(p_min, y_min)
#
# Hacemos la gráfica base
#
fig, ejes = inicializaGrafica(y_maximo, yticks)
...
#
# Realizamos las gráficas de los países elegeidos.
#
for p, c in paises_colores.items():
    par = {'lw':2.0, 'c':c, 'marker':''}
    graficaFertilidadUnPais(paises, p, 0, par)
#
...
# la animación.
#
l, lg, t1 = graficaFertilidadUnPais(paises, 'Mexico', 13, par, par_glow, 3) 
#
